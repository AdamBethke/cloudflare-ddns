...
FAILED_REQUESTS = Counter("failed_requests", "Number of failed requests made by the service", ["method", "endpoint"])
...
def failed_request(
    ...
    metric.labels(method=method, endpoint=endpoint).inc()
